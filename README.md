...
| 📂 **Copy buckets**    | `isaura copy -m eos9876 -v v2 -pn oncology-private -o ./dump/eos9876-v2/`                                     | Copy all model artifacts from a project to a local directory.                                             |
| 🚚 **Move buckets**            | `isaura move -m eos9876 -v v2 -pn oncology-private`                                                           | Move or relocate artifacts for a specific model/version within the project.                               |
| 🗑️ **Remove buckets**         | `isaura remove -m eos9876 -v v2 -pn oncology-private --yes`                                                   | Permanently delete all artifacts for a model/version from a project (requires confirmation with `--yes`). |
...
| 📋 **List available model results**      | `isaura inspect -m eos9876 -v v2 --access both -o reports/available.csv`                                      | List all available inputs or files related to a model/version.                                            |
